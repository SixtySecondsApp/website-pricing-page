...
const ModernShowcase = ({ currency, showPricing: initialShowPricing }) => {
  ...
  const pricingData = {
    ...
    USD: {
      ...
      'Scale': {
        monthly: { total: 3650, deposit: 730, afterKickoff: 2920, link: 'https://sixtyseconds.chargebee.com/hosted_pages/checkout?subscription_items[item_price_id][0]=Onboarding-Reserve---Scale-USD-Monthly&utm_source=cb-app-copy' },
        annual: { total: 36500, deposit: 7300, afterKickoff: 29200, link: 'https://sixtyseconds.chargebee.com/hosted_pages/checkout?subscription_items[item_price_id][0]=Onboarding-Reserve---Scale-USD-Yearly&utm_source=cb-app-copy' }
      }
    },
    EUR: {
      'Self Managed': {
